...
function reportMonitoring($smarty, $module_name, $local_templates_dir, &$pDB, $pACL, $arrConf, $user, $extension)
{
    ...
    $date_ini = getParameter("date_start_shamsi");
    ...
    $_POST['date_start_shamsi'] = isset($date_ini) ? $date_ini : adad_en_to_fa($shamdatestr['shamsi_d'] . " " . $shamdatestr['shamsi_mn'] . " " . $shamdatestr['shamsi_y']);
    $_POST['date_end_shamsi'] = isset($date_end) ? $date_end : adad_en_to_fa($shamdatestr['shamsi_d'] . " " . $shamdatestr['shamsi_mn'] . " " . $shamdatestr['shamsi_y']);
    $_POST['limit'] = isset($limit) ? $limit : '100000';

    if ($date_ini === "") {
        $_POST['date_start_shamsi'] = " ";
    }
    if ($date_end === "") {
        $_POST['date_end_shamsi'] = " ";
    }
    ...
    $date_initial = tarjomedatehshamsi($_POST['date_start_shamsi'] . " 00:00:00");
    $date_final = tarjomedatehshamsi($_POST['date_end_shamsi'] . " 23:59:59");
    ...
    $paramFilter = array(
        ...
        'date_start_shamsi' => $_POST['date_start_shamsi'],
        'date_end_shamsi' => $_POST['date_end_shamsi'],
    ...
    $htmlFilter = $oFilterForm->fetchForm("$local_templates_dir/filter.tpl", "", $paramFilter);
    ...
    $MsgFilter = "<b>" . _tr("Filter applied: ") . "</b>" .
        ...
        _tr("Start Date") . " = " . $paramFilter['date_start_shamsi'] . ", " .
        _tr("End Date") . " = " . $paramFilter['date_end_shamsi'] . " - " .
