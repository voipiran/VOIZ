<?php /* Smarty version Smarty-3.1.7, created on 2018-11-26 14:47:20
         compiled from "/var/www/webroot/ROOT/includes/runtime/../../layouts/v7/modules/Vtiger/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19590417345acb4e965dc363-89627110%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99eee8f0d0b7eb339a6bced0028e7be1fa51d838' => 
    array (
      0 => '/var/www/webroot/ROOT/includes/runtime/../../layouts/v7/modules/Vtiger/Header.tpl',
      1 => 1543230864,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19590417345acb4e965dc363-89627110',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5acb4e9669896',
  'variables' => 
  array (
    'PAGETITLE' => 0,
    'QUALIFIED_MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5acb4e9669896')) {function content_5acb4e9669896($_smarty_tpl) {?>
...
"};<?php }?></script><!--Metro Notificacion--><link href="include/static/css/MetroNotificationStyle.css" rel="stylesheet" type="text/css" media="screen" /><!-- Notificacion functions is in here (needed) --><script src="include/static/js/MetroNotification.js"></script><!-- Demo site style (optional) --><link href="include/static/css/style.css" rel="stylesheet" type="text/css" media="screen" /><link type="text/css" href="libraries/jquery/jquery-ui/jalali-datepicker/styles/jquery-ui-1.8.14.css" rel="stylesheet"/><?php if ($_smarty_tpl->tpl_vars['LANGUAGE']->value=='fa_ir'){?><link href="layouts/v7/skins/rtl.css" rel="stylesheet" type="text/css" media="screen" /><link href="layouts/v7/skins/font.css" rel="stylesheet" type="text/css" media="screen" /><?php }?></head><?php $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL'] = new Smarty_variable(Users_Record_Model::getCurrentUserModel(), null, 0);?><body data-skinpath="<?php echo Vtiger_Theme::getBaseThemePath();?>
