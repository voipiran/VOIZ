<?php /* Smarty version Smarty-3.1.7, created on 2018-04-09 15:59:27
         compiled from "/var/www/webroot/ROOT/includes/runtime/../../layouts/v7/modules/Vtiger/JSResources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15790744035acb4e97470c20-86445849%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ae2a50324ab8b914c2fa70d5e25446e93b36b86' => 
    array (
      0 => '/var/www/webroot/ROOT/includes/runtime/../../layouts/v7/modules/Vtiger/JSResources.tpl',
      1 => 1522235170,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15790744035acb4e97470c20-86445849',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5acb4e974dcbd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5acb4e974dcbd')) {function content_5acb4e974dcbd($_smarty_tpl) {?>
...
";jQuery(document).ready(function() { window._PAGEREADYAT = new Date(); });
		...
		});</script><!-- Hooman Kouhfallah - Cytco : Added jQuery UI Datepicker --><script type="text/javascript" src="libraries/jquery/jquery-ui/jalali-datepicker/scripts/jquery.ui.datepicker-cc.js"></script><script type="text/javascript" src="libraries/jquery/jquery-ui/jalali-datepicker/scripts/calendar.js"></script><script type="text/javascript" src="libraries/jquery/jquery-ui/jalali-datepicker/scripts/jquery.ui.datepicker-cc-fa.js"></script><script type="text/javascript" src="libraries/jquery/jquery-ui/jalali-datepicker/scripts/jquery-ui.multidatespicker.js"></script>
	<script>
		jQuery.browser = {};
		(function () {
	...
	<!-- Added jQuery UI Datepicker --><?php }} ?>